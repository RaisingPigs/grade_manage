    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="list-group text-center">
                <a href="${APP_PATH}/studentHomeworkControl/${sId}" class="list-group-item">个人信息</a>
        ...
        <div class="col-md-5 col-md-offset-2">
            <div class="panel panel-default text-center">
                <div class="panel-heading school-news">${expr.question}</div>
                <ul class="list-group">
...
<script>
    $(function () {
        $.ajax({
            url: "${APP_PATH}/getExprAnswer/" + ${sId} +"/" + ${exprId},
            type: "get",
            success: function (result) {
                if (result.extend.expr.answer !== "") {
                    $("#answer").val(result.extend.expr.answer);
                ...
                if (result.extend.expr.exprGrd !== 0) {
                    $(".grade").text(result.extend.expr.exprGrd);
                } else {
                    $(".grade").text("未批阅");
                }

                if (result.extend.expr.exprGrd < 60 && result.extend.expr.exprGrd !== 0) {
    ...
    $(".my-submit").click(function () {
        if (confirm("确定要提交作业吗?")) {
            $.ajax({
                url: "${APP_PATH}/updateExprAnswer/${sId}/${exprId}",
                type: "put",
                data: $("#answer"),
                success: function (result) {
                    if (result.code === 100) {
