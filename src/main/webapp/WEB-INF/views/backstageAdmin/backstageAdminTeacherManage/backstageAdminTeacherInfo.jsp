                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="stuName_update_div">
                            <input type="text" class="form-control " name="tchName" id="stuName_update_input"
                                   autocomplete="off"
                                   placeholder="输入新的教师姓名" data-toggle="tooltip" title="用户名必须是2-5位中文!">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="tchSex" id="stuSex1_update_input" value="男" checked="checked">
                                男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="tchSex" id="stuSex2_update_input" value="女"> 女
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="stuAge_update_div">
                            <input type="text" class="form-control" name="tchAge" id="stuAge_update_input"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" name="tchClass" id="stuClass_update_select">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select class="form-control" name="cName" id="stuMajor_update_select">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title text-center" id="myModalLabel">增加教师</h4>
            </div>
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="stuName_add_div">
                            <input type="text" class="form-control " name="tchName" id="stuName_add_input"
                                   autocomplete="off"
                                   placeholder="输入教师姓名" data-toggle="tooltip" title="用户名必须是2-5位中文!">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">性别</label>
                        <div class="col-sm-10">
                            <label class="radio-inline">
                                <input type="radio" name="tchSex" id="tchSex1_add_input" value="男" checked="checked"> 男
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="tchSex" id="tchSex2_add_input" value="女"> 女
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="stuAge_add_div">
                            <input type="text" class="form-control" name="tchAge" id="stuAge_add_input"
                                   placeholder="输入教师年龄" autocomplete="off" data-toggle="tooltip" title="年龄格式不正确!">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">班级</label>
                        <div class="col-sm-3">
                            <select class="form-control" name="tchClass" id="stuClass_add_select">
                                <option value="2001">2001</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">课程</label>
                        <div class="col-sm-3">
                            <select class="form-control" name="cName" id="stuMajor_add_select">
                                <option value="java">java</option>
                                <option value="c">c</option>
                                <option value="cpp">c++</option>
                            </select>
    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li>
                    <a href="${APP_PATH}/backstageAdminStudentPasswordControl"><span class="glyphicon glyphicon-edit"></span> 密码管理</a>
                </li>
                <li>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-info text-center my-alert-nav" role="alert">教 师 信 息 管 理</div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="list-group text-center">
                <a href="${APP_PATH}/backstageAdminTeacherInfoControl" class="list-group-item active">教师信息</a>
                <a href="#" class="list-group-item">作业管理</a>
                <a href="#" class="list-group-item">教师评分</a>
                <a href="#" class="list-group-item">班级信息</a>
                <a href="#" class="list-group-item">课程信息</a>
                <a href="#" class="list-group-item">院系信息</a>
                <a href="#" class="list-group-item">宿舍信息</a>
                <a href="#" class="list-group-item">优秀教师</a>
            </div>
        </div>
...
<script>
    ...
    function build_stu_table(result) {
        ...
        $.each(stus, function (index, item) { /*下标和下标对应的信息*/
            /*创建员工信息的td*/
            var stuIdTd = $("<td></td>").addClass("text-center").append(item.tchId);
            var stuNameTd = $("<td></td>").addClass("text-center").append(item.tchName);
            var stuSexTd = $("<td></td>").addClass("text-center").append(item.tchSex);
            var stuAge = $("<td></td>").addClass("text-center").append(item.tchAge);
            var stuMajor = $("<td></td>").addClass("text-center").append(item.tchClass);
            var stuClass = $("<td></td>").addClass("text-center").append(item.cName === "cpp" ? "c++" : item.cName);
            ...
            editBtn.attr("edit-id", item.tchId);
    ...
    function getStu(id) {
        $.ajax({
            url: "${APP_PATH}/getTeacher/" + id,
            type: "get",
            success: function (result) {
                var stuData = result.extend.teacher;
                $("#stuName_update_input").val(stuData.tchName);

                /*单选框和下拉列表, 要用[]*/
                $("#stuUpdateModal input[name=tchSex]").val([stuData.tchSex]);

                $("#stuAge_update_input").val(stuData.tchAge);

                $("#stuUpdateModal select[name=cName]").val([stuData.cName]);
            }
        });
    }
    ...
    $("#stu_update_btn").click(function () {
        ...
        /*发送ajax请求保存数据*/
        $.ajax({
            url: "${APP_PATH}/updateTeacher/" + $(this).attr("edit-id"),
            type: "put",
    ...
    $(document).on("click", ".del_btn", function () {
        ...
        if (confirm("确定删除 " + stuName + " 吗?")) {
            $.ajax({
                url: "${APP_PATH}/deleteTeacher/" + stuId,
                type: "delete",
                success: function (result) {
                    /*删除后回到本页*/
                    to_page(currentPage);
    ...
    function to_search_page(pn, stuName) {
        $.ajax({
            url: "${APP_PATH}/searchTeacher/" + stuName + "/" + pn,
            type: "get",
            success: function (result) {
                console.log(result);
                /*1. 成功后在页面解析json, 显示数据*/
