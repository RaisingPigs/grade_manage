            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="stuName_add_input" class="col-sm-2 control-label">实验</label>
        ...
        <div class="col-md-10">
            <div class="row my-search-div">
                <div class="col-md-3 pull-right">
                    <button class="btn btn-primary center-block" id="stu_add_modal_btn">发布实验</button>
                </div>
            </div>

            <div class="common">
                <ul class="expr_show">
                    <c:forEach items="${distinctExperiment}" var="item">
                        <li class="listbox mr20">
                            <div class="listimg">
                                <a href="${APP_PATH}/teacherStudentExperimentControl/${tId}/${item.exprId}">
                            ...
                            <div class="list-info">
                                ...
                                <div class="list-demo delete_expr" id="${item.exprId}"><a href="#">删除</a></div>
                            </div>
                        </li>
                    </c:forEach>
                </ul>
...
<script>
    ...
    $(".delete_expr").click(function () {
        if (confirm("你确定要删除吗?")) {
            $.ajax({
                url: "${APP_PATH}/deleteExpr/" + $(this).attr("id"),
                type: "delete",
                success: function (result) {
                    if (result.code === 100) {
