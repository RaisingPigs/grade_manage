    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                ...
                <li class="active">
                    <a href="${APP_PATH}/teacherPersonalInfoControl/${tId}"><span
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="list-group text-center">
                <a href="${APP_PATH}/teacherPersonalInfoControl/${tId}" class="list-group-item active">个人信息</a>
        ...
        <div class="col-md-5 col-md-offset-2">
            <div class="panel panel-default text-center">
                <div class="panel-heading school-news">教 &nbsp 师</div>
                <ul class="list-group">
                    <li class="list-group-item">
                        <span>教师号: </span>
                        <span>${teacher.tchId}</span>
                    </li>
                    <li class="list-group-item">
                        <span>姓名: </span>
                        <span>${teacher.tchName}</span>
                    </li>
                    <li class="list-group-item">
                        <span>性别: </span>
                        <span>${teacher.tchSex}</span>
                    </li>
                    <li class="list-group-item">
                        <span>年龄: </span>
                        <span>${teacher.tchAge}</span>
                    </li>
                    <li class="list-group-item">
                        <span>班级: </span>
                        <span>${teacher.tchClass}</span>
                    </li>
                    <li class="list-group-item">
                        <span>课程: </span>
                        <span>${teacher.cName}</span>
                    </li>
                </ul>
            </div>
