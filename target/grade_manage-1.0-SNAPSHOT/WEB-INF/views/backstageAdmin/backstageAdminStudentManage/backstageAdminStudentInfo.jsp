...
<head>
    ...
    <%--<link rel="stylesheet" href="${APP_PATH}/static/bg/css/style.css">--%>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="list-group text-center">
                <a href="${APP_PATH}/backstageAdminStudentInfoControl" class="list-group-item active">学生信息</a>
                <a href="${APP_PATH}/backstageAdminStudentGradeControl" class="list-group-item">学生成绩</a>
