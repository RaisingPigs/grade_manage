        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label for="java_update_input" class="col-sm-2 control-label">java</label>
                        <div class="col-sm-10" id="java_update_div">
                            <input type="text" class="form-control" name="java" id="java_update_input"
                                   placeholder="输入新的java成绩" autocomplete="off" data-toggle="tooltip" title="成绩格式不正确!">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="c_update_input" class="col-sm-2 control-label">c</label>
                        <div class="col-sm-10" id="c_update_div">
                            <input type="text" class="form-control" name="c" id="c_update_input"
                                   placeholder="输入新的c语言成绩" autocomplete="off" data-toggle="tooltip" title="成绩格式不正确!">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="cpp_update_input" class="col-sm-2 control-label">cpp</label>
                        <div class="col-sm-10" id="cpp_update_div">
                            <input type="text" class="form-control" name="cpp" id="cpp_update_input"
                                   placeholder="输入新的c++成绩" autocomplete="off" data-toggle="tooltip" title="成绩格式不正确!">
                        </div>
                    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="list-group text-center">
                <a href="${APP_PATH}/backstageAdminStudentInfoControl" class="list-group-item">学生信息</a>
                <a href="${APP_PATH}/backstageAdminStudentGradeControl" class="list-group-item active">学生成绩</a>
...
<script>
    ...
    function build_stu_table(result) {
        ...
        $.each(stus, function (index, item) { /*下标和下标对应的信息*/
            ...
            var stuMajor = $("<td></td>").addClass("text-center").append(item.grades[0].c);
            var stuClass = $("<td></td>").addClass("text-center").append(item.grades[0].cpp);
    ...
    function getStu(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#java_update_input").val(stuData.grades[0].java);
                $("#c_update_input").val(stuData.grades[0].c);
                $("#cpp_update_input").val(stuData.grades[0].cpp);
            }
        });
    }
    ...
    $("#stu_update_btn").click(function () {
        ...
        /*发送ajax请求保存数据*/
        $.ajax({
            url: "${APP_PATH}/updateStuGrade/" + $(this).attr("edit-id"),
            type: "put",
