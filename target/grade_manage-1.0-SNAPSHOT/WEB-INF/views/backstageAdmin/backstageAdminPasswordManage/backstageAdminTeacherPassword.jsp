                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="stuPwd_update_div">
                            ...
                            <input type="password" name="tchPwd" id="stuPwd" hidden="hidden">
                        </div>
                    </div>
                </form>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="alert alert-info text-center my-alert-nav" role="alert">教 师 密 码 管 理</div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-2">
            <div class="list-group text-center">
                <a href="${APP_PATH}/backstageAdminStudentPasswordControl" class="list-group-item">学生密码</a>
                <a href="${APP_PATH}/backstageAdminTeacherPasswordControl" class="list-group-item active">教师密码</a>
            </div>
        </div>
    ...
    function getStu(id) {
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#stuSex_update_input").val(stuData.tchSex);

                $("#stuAge_update_input").val(stuData.tchAge);
                $("#stuClass_update_input").val(stuData.tchClass);
                $("#stuMajor_update_input").val(stuData.cName === "cpp" ? "c++" : stuData.cName);
            }
        });
    }
